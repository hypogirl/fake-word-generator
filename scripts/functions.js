...
function isConsonant(letter) {
    return (!["á","à","â","ǎ","ă","ã","ả","ȧ","ạ","ä","å","é","è","ê","ḙ","ě","ĕ","ẽ","ḛ","ẻ","ė","ë","ē","ȩ","ę","í","ì","ĭ","î","ǐ","ï","ḯ","ĩ","į","ī","ó","ò","ŏ","ô","ố","ồ","ỗ","ổ","ǒ","ö","ȫ","ő","õ","ú","ù","ŭ","û","ǔ","ů","ü","ǘ","ǜ","ǚ","ǖ","ű",'я','o','ё','ю','у','э','е','и','ы'].includes(letter))
};
